            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td width="40%" class="logo" style="text-align: left;">
                  <h1><a href="#">IoT Water Meter System</a></h1>
                </td>
              </tr>
            </table>
          </td>
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                      <td width="40%" class="logo" style="text-align: center;">
                        <h2>Using Technology that changes life</h2>
                       C
                      </td>
                    </tr>
                  </table>
...
def getEmailMessage(userName: str, month: str, amount: float):
    return ''.join([ header, body.format(month, userName ,month, amount), footer])

def sendBilling(userEmail:str, userName: str, month: str, amount: str):
    subject:str = F"IoT Water Meter System: Bill for {month}"
